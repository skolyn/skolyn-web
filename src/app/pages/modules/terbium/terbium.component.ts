...
@Component({
  ...
  styles: [`
    ...
    .element-badge { display: inline-flex; flex-direction: column; align-items: center; padding: 12px 16px; border: 2px solid var(--color-terbium); border-radius: var(--md-sys-shape-corner-medium); margin-bottom: 24px; background: var(--md-sys-color-surface-container); }
    ...
    .pipe-num { width: 36px; height: 36px; border-radius: 50%; background: var(--color-terbium); color: var(--md-sys-color-on-primary); display: flex; align-items: center; justify-content: center; font: var(--md-sys-typescale-label-large); margin-bottom: 16px; }
