        ...
        <div class="contact-grid">
          <div class="contact-form-wrapper animate-in">
            ...
            <form class="contact-form" (submit)="onSubmit($event)">
              ...
              <p class="form-status body-medium" [class.error]="submitStatus === 'error'" *ngIf="submitStatus !== 'idle'">
                {{ submitStatus === 'success' ? 'Thank you for your message. Our team will reach out within 24 hours.' : 'We could not send your message right now. Please try again shortly.' }}
              </p>
            </form>
          </div>
