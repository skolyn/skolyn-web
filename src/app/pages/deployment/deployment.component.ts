...
@Component({
  ...
  styles: [`
    ...
    .training-role {
      ...
      font: var(--md-sys-typescale-label-large); color: var(--md-sys-color-on-primary); margin-bottom: 16px;
    }
    ...
    .tier-header {
      padding: 28px 24px; color: var(--md-sys-color-on-primary); text-align: center;
