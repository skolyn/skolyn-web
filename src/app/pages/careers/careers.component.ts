              ...
              @if (expandedJob === job.id) {
                <div class="job-body">
                  ...
                  <div class="apply-section">
                    ...
                    <form class="apply-form" (submit)="$event.preventDefault(); submitApplication(job.id)">
                      <div class="form-row">
...
export class CareersComponent {
  ...
  submitApplication(jobId: string) {
    alert('Thank you for your interest! Your application for ' + jobId + ' has been submitted. We will review and get back to you within 2 weeks.');
  }
}
