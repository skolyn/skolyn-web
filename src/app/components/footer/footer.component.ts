...
@Component({
        ...
        <div class="footer-grid">
          <div class="footer-col brand-col">
            ...
            <div class="newsletter-box">
              <p class="label-large newsletter-label">Stay Updated</p>
              <form class="newsletter-form" (submit)="$event.preventDefault(); subscribeNewsletter()">
                <input type="email" placeholder="your@email.com" required #newsletterEmail />
                <button type="submit" [disabled]="isSubscribing" aria-label="Subscribe">
                  <span class="material-symbols-outlined sz-20">{{ isSubscribing ? 'hourglass_empty' : 'arrow_forward' }}</span>
                </button>
              </form>
            </div>
          </div>
          ...
          <div class="footer-col">
            ...
            <a tabindex="0" (click)="copyEmail()" (keydown.enter)="copyEmail()" class="copy-link" title="Copy to clipboard">hello&#64;skolyn.se</a>
        ...
        <div class="container-wide footer-bottom-inner">
          ...
          <div class="programs-by">
            ...
            <div class="program-links">
              ...
              >
                <img src="assets/microsoft-for-startups.png" alt="Microsoft for Startups Founders Hub" class="innoland-footer-logo" />
              </a>
              <a
              ...
              >
                <img src="assets/nvidia-inception.png" alt="NVIDIA Inception Program" class="innoland-footer-logo" />
              </a>
            </div>
          </div>
  ...
  styles: [`
    ...
    .footer-col a, .footer-col .copy-link {
    ...
    .footer-col a:hover, .footer-col .copy-link:hover { color: var(--md-sys-color-primary); text-decoration: none; }
    ...
    .newsletter-form input {
      flex: 1; padding: 10px 14px; border: 1px solid var(--md-sys-color-outline-variant);
      border-radius: var(--md-sys-shape-corner-medium) 0 0 var(--md-sys-shape-corner-medium);
      font: var(--md-sys-typescale-body-medium); color: var(--md-sys-color-on-surface);
      background: var(--md-sys-color-surface); outline: none; min-width: 0;
    }
    .newsletter-form input:focus { border-color: var(--md-sys-color-primary); }
    .newsletter-form button {
      padding: 10px 14px; background: var(--md-sys-color-primary); color: var(--md-sys-color-on-primary);
      border: none; border-radius: 0 var(--md-sys-shape-corner-medium) var(--md-sys-shape-corner-medium) 0;
    ...
    .newsletter-msg { display: flex; align-items: center; gap: 6px; font: var(--md-sys-typescale-body-small); margin-top: 8px; }
    .newsletter-msg.success { color: #1e8e3e; }
    .newsletter-msg.error { color: #d93025; }
...
export class FooterComponent {
  ...
  copyEmail() {
    navigator.clipboard.writeText('hello@skolyn.se').then(() => {
      this.toastService.show('Email address copied to clipboard!', 'success', 3000);
    }).catch(() => {
      this.toastService.show('Failed to copy email address.', 'error', 3000);
    });
  }
}
